<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    </a> --}}<a href="{{ route('home') }}" class="flex items-center space-x-3 rtl:space-x-reverse">
        <svg class="w-10 mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 340 340">
          ...
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MAKTABATY</span>
        </a>
                </div>
            </div>
